...
const NAV_ITEMS = [
  ...
  { href: 'admin/masters/citizens', label: 'नागरिक मास्टर', labelEn: 'Citizens',        Icon: Database, feature: 'tax' as Feature },
  { href: 'admin/masters/properties', label: 'मालमत्ता मास्टर', labelEn: 'Properties',  Icon: ClipboardList, feature: 'tax' as Feature },
  { href: 'admin/masters/property-type-rates', label: 'मालमत्ता दर', labelEn: 'Property rates', Icon: BadgeIndianRupee, feature: 'tax' as Feature },
  { href: 'admin/masters/water-connections', label: 'पाणी जोडण्या', labelEn: 'Water connections', Icon: Database, feature: 'tax' as Feature },
  { href: 'admin/masters/water-connection-rates', label: 'पाणी दर', labelEn: 'Water rates', Icon: BadgeIndianRupee, feature: 'tax' as Feature },
  { href: 'admin/masters/import', label: 'Excel आयात',      labelEn: 'Excel import',    Icon: Database, feature: 'tax' as Feature },
